...
; File: "z-koren1_.c", produced by Gambit-C v4.5.1
(
405001
" z-koren1_"
(" _kernel" " _system" " _num" " _std" " _eval" " _io" " _nonstd" " _thread" " _repl" " z-koren1")
(
""
"##and"
"##apply"
...
#define ___LINKFILE_NAME " z-koren1_"
#define ___LINKER_ID ____20_z_2d_koren1__
...
___BEGIN_NEW_LNK
___DEF_NEW_LNK(____20_z_2d_koren1)
___END_NEW_LNK

___BEGIN_LNK
 ___DEF_LNK(____20___gambc)
,___DEF_LNK(____20_z_2d_koren1)
___END_LNK
...
___DEF_SUB_NSTR(___X0,9)
               ___NSTR8(32,122,45,107,111,114,101,110)
               ___NSTR1(49)
___DEF_NEW_SYM_GLO_SUP(0,___S__20_z_2d_koren1,___X0,230900395,___G__20_z_2d_koren1)
___DEF_SUB_NSTR(___X1,3)
               ___NSTR3(97,118,103)
___DEF_NEW_SYM_GLO_SUP(___S__20_z_2d_koren1,___S_avg,___X1,268831766,___G_avg)
___DEF_SUB_NSTR(___X2,5)
               ___NSTR5(100,101,110,117,108)
___DEF_NEW_SYM_GLO_SUP(___S_avg,___S_denul,___X2,58498680,___G_denul)
___DEF_SUB_NSTR(___X3,11)
               ___NSTR8(102,105,120,101,100,45,112,111)
               ___NSTR3(105,110,116)
___DEF_NEW_SYM_GLO_SUP(___S_denul,___S_fixed_2d_point,___X3,456103902,___G_fixed_2d_point)
___DEF_SUB_NSTR(___X4,2)
               ___NSTR2(103,111)
___DEF_NEW_SYM_GLO_SUP(___S_fixed_2d_point,___S_go,___X4,370261346,___G_go)
___DEF_SUB_NSTR(___X5,6)
               ___NSTR6(109,97,120,110,117,109)
___DEF_NEW_SYM_GLO_SUP(___S_go,___S_maxnum,___X5,19401349,___G_maxnum)
___DEF_SUB_NSTR(___X6,11)
               ___NSTR8(109,107,109,97,103,110,105,116)
               ___NSTR3(117,100,101)
___DEF_NEW_SYM_GLO_SUP(___S_maxnum,___S_mkmagnitude,___X6,201684797,___G_mkmagnitude)
___DEF_SUB_NSTR(___X7,5)
               ___NSTR5(110,115,113,114,116)
___DEF_NEW_SYM_GLO_SUP(___S_mkmagnitude,___S_nsqrt,___X7,367338811,___G_nsqrt)
___DEF_SUB_NSTR(___X8,4)
               ___NSTR4(115,97,118,103)
___DEF_NEW_SYM_GLO_SUP(___S_nsqrt,___S_savg,___X8,306675060,___G_savg)
___DEF_SUB_NSTR(___X9,5)
               ___NSTR5(115,99,111,109,112)
___DEF_NEW_SYM_GLO_SUP(___S_savg,___S_scomp,___X9,229089038,___G_scomp)
___DEF_SUB_NSTR(___X10,5)
               ___NSTR5(115,100,105,102,102)
___DEF_NEW_SYM_GLO_SUP(___S_scomp,___S_sdiff,___X10,421876008,___G_sdiff)
___DEF_SUB_NSTR(___X11,4)
               ___NSTR4(115,100,105,118)
___DEF_NEW_SYM_GLO_SUP(___S_sdiff,___S_sdiv,___X11,514500137,___G_sdiv)
___DEF_SUB_NSTR(___X12,8)
               ___NSTR8(115,105,110,118,101,114,115,101)
               ___NSTR0
___DEF_NEW_SYM_GLO_SUP(___S_sdiv,___S_sinverse,___X12,498256298,___G_sinverse)
___DEF_SUB_NSTR(___X13,6)
               ___NSTR6(115,109,105,110,117,115)
___DEF_NEW_SYM_GLO_SUP(___S_sinverse,___S_sminus,___X13,225496409,___G_sminus)
___DEF_SUB_NSTR(___X14,4)
               ___NSTR4(115,109,117,108)
___DEF_NEW_SYM_GLO_SUP(___S_sminus,___S_smul,___X14,437485421,___G_smul)
___DEF_SUB_NSTR(___X15,4)
               ___NSTR4(115,111,117,116)
___DEF_NEW_SYM_GLO_SUP(___S_smul,___S_sout,___X15,437438400,___G_sout)
___DEF_SUB_NSTR(___X16,5)
               ___NSTR5(115,112,108,117,115)
___DEF_NEW_SYM_GLO_SUP(___S_sout,___S_splus,___X16,342372657,___G_splus)
___DEF_SUB_NSTR(___X17,6)
               ___NSTR6(115,115,97,109,101,63)
___DEF_NEW_SYM_GLO_SUP(___S_splus,___S_ssame_3f_,___X17,88998335,___G_ssame_3f_)
___DEF_SUB_NSTR(___X18,5)
               ___NSTR5(115,115,113,114,116)
___DEF_NEW_SYM_GLO_SUP(___S_ssame_3f_,___S_ssqrt,___X18,371360976,___G_ssqrt)
___DEF_SUB_NSTR(___X19,8)
               ___NSTR8(116,114,97,110,115,102,101,114)
               ___NSTR0
___DEF_NEW_SYM_GLO_SUP(___S_ssqrt,___S_transfer,___X19,149193997,___G_transfer)
___END_NEW_SYM_GLO(___S_transfer,0)
